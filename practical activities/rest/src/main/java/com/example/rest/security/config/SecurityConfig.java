...
import com.example.rest.security.exception.SecurityExceptionHandler;
import com.example.rest.security.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
  ...
  /*
   * Cadena de filtros y reglas de seguridada HTTP.
   * - Desactiva CSRF porque trabajamos con tokens (no cookies).
   * - Sessión STATELESS: no se guarda estado del usuario en servidor.
   ...
   * - allowrdOrigins: toma la lista desde propiedades (security.cors.allowed-origins),
