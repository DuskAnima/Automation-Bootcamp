...
import com.example.rest.security.domain.Role;
import com.example.rest.security.domain.UserAccount;
import com.example.rest.security.dto.AuthResponse;
import com.example.rest.security.dto.LoginRequest;
import com.example.rest.security.dto.RegisterRequest;
import com.example.rest.security.jwt.JwtProperties;
import com.example.rest.security.jwt.JwtService;
import com.example.rest.security.repository.UserAccountRepository;
 ...
 * - 400 Unauthorized: credenciales inválidos o refresh token inválido/expirado.
...
public class AuthController {
  ...
  // Repositorio de usuarios para consultas y presistencia.
   ...
   * Lanza IllegalArgumentException si el username ya existe (manejada por advice global).
   */
