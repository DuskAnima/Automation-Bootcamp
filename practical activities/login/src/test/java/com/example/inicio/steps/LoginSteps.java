package com.example.inicio.steps;
...
import com.example.inicio.pages.LoginPage;
...
public class LoginSteps {
    ...
    public void setUp() {
        ...
        chromeOptions.addArguments("--headless"); // En integraciones continuas se usa headless.
    ...
    public void ingresa_usuario_y_clave(String usuario, String clave) {
        ...
        tomarSnapshot("snapshop_despues_de_login");
    }
    ...
    public void deberia_ver_el_mensaje(String mensaje) {
        ...
        tomarSnapshot("snapshot_welcome_message");
    }
    ...
    private void tomarSnapshot(String nombre) {
        try {
            ...
            String fileName = "target/screenshot/" + nombre + ".png";
